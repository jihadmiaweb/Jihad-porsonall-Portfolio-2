...
const Contacts = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      text: "jihadmiaweb@gmail.com",
      // link: "mailto:elorayasmin20@gmail.com",
    },
  ];

  return (
    <section id="contacts" className="py-10 md:py-14 lg:py-20 px-6 mx-auto">
      <div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-12 ">
        ...
        >
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] bg-clip-text text-transparent mb-2">
              Let's Connect
            </h2>
          ...
          <div className="flex flex-col gap-3 w-full max-w-md">
            {contactInfo.map((info, index) => (
              <motion.a
                ...
                viewport={{ once: true }}
                className="flex items-center gap-3 p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-[#00bf8f] transition-all duration-300 group"
              >
                {info.icon}
        ...
        <motion.form
          ...
          className="flex flex-col gap-5 flex-1 max-w-lg w-full bg-gray-800/30 p-6 md:p-8 rounded-2xl border border-gray-700 shadow-md shadow-[#00bf8f]/40"
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="btn w-full bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] border-0 text-white hover:shadow-lg hover:shadow-[#00bf8f]/40 transition-all duration-300 flex items-center justify-center gap-2 font-medium"
          >
            {state.submitting ? (
              <>
